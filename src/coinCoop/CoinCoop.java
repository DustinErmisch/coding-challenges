 ...
 * 
 * Here's an example of Red taking advantage of Green! Red chose to betray The
 * Challenge
 * 
 ...
 * of strings, with each string being the words "share" or "steal". Examples
 * 
 * getCoinBalances(["share"], ["share"]) ➞ [5, 5] // Both people spend one coin,
 * and receive 3 coins each.
 * 
 * getCoinBalances(["steal"], ["share"]) ➞ [6, 2] // Person 1 gains 3 coins,
 * while person 2 loses a coin.
 * 
 * getCoinBalances(["steal"], ["steal"]) ➞ [3, 3] // Neither person spends any
 * coins and so no one gets rewarded.
 * 
 ...
 * Notes
 * 
 * No tests will include a negative number of coins. All words will be given in
 * lowercase. This challenge is adapted from a famous game theory example called
 * the Prisoner's Dilemma, which you can learn more about in the Resources tab.
 */
...
public class CoinCoop {
	...
	public static int[] getCoinBalances(String[] array1, String[] array2) {
		...
		for (int i = 0; i < array1.length; i++) {
			...
			// jedes Array Element beider Elemente an der Stelle i miteinander vergleichen
			// und Punkte an return array vergeben
