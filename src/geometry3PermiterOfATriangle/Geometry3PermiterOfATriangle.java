 ...
 * 
 * Write a function that takes the coordinates of three points and returns the
 * perimeter of the triangle. The given points are the vertices of a triangle on
 * a two-dimensional plane. Examples
 * 
 ...
 * Notes
 * 
 * The given points always create a triangle. The numbers in the argument array
 * can be positive or negative. There is 0.1 tolerance, so you don't need to
 * round your result. This challenge is easier than it looks.
 */
