 ...
 * 
 * Write a function that returns true if you can partition an array into one
 * element and the rest, such that this element is equal to the product of all
 * other elements excluding itself. Examples
 * 
 ...
 * Notes
 * 
 * The array may contain duplicates. Multiple solutions can exist, any solution
