...
public class PersistenLittleBugger {
	...
	public static int bugger2(int zahl, int j) {
		...
		//wenn die zahl noch groesser ist als 9, also mehr als eine Stelle dann rekursion
		if (zahl > 9) {
			//j wird dadurch aktualisiert und spiegelt die Anzahl der Rekursionsdurchleaufe wieder
			j = bugger2(zahl, j);
